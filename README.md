...
- **Description**: TSENAT is an R package for quantifying and modelling the relative isoform-usage complexity across samples. It provides a complementary, _orthogonal_ analytical method to standard differential-expression tools.
