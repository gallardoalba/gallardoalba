...
- **Description**: This essay aims to combat the neoliberal-conservationism ideology, that is, the consideration that throught technoscience is possible to manage the ecological collapse, whilst, in an act of utter irrationality, sidestepping the root cause: the dominant system of production.
